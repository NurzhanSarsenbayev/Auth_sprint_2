...
# JWKS
AUTH_JWKS_URL = os.getenv(
    "AUTH_JWKS_URL", "http://auth_service:8000/api/v1/auth/.well-known/jwks.json"
)

ADMIN_SUPERUSERS = set(x.strip() for x in os.getenv("ADMIN_SUPERUSERS", "").split(",") if x.strip())
