...
from services.genres.genre_parsers import (
    parse_genre_from_hit,
    parse_genres_from_agg,
    parse_genres_with_filter,
)
...
async def fetch_genre_by_id(service, genre_uuid: UUID) -> Genre | None:
